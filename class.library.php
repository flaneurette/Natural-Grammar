...
class library extends grammar
{
    ...
    */
	...
	public $opinionAdjectives = [
		'attentive', 'awful', 'irritating', 'interesting', 'brave', 'dutiful', 'patient', 'serious', 'unstable', 'unwilling',
		'inactive', 'active',
		'brilliant', 'honest', 'judgmental', 'careless', 'logical', 'punctual', 'childish', 'experienced', 'efficient',
		'egoistic', 'excited', 'haughty',
		'proud', 'coward', 'gentle', 'helpful', 'modest', 'sweet', 'volcanic', 'aggressive', 'arrogant', 'beautiful',
		'wonderful', 'smart', 'talented',
		'versatile', 'sophisticated', 'sensitive', 'polite', 'kind', 'dramatic', 'nosy', 'quiet', 'tactful', 'tired',
		'immature', 'diligent', 'blunt'
	];

	public $sizeAdjectives = [
		'gigantic', 'pocket-size', 'undersized', 'grand', 'portly', 'underweight', 'great', 'pudgy', 'unlimited', 'heavy',
		'puny', 'vast',
		'heavy', 'light', 'big', 'small', 'little', 'tiny', 'tall', 'short', 'fat', 'thin', 'slender', 'willowy', 'lean',
		'lean', 'slender', 'bulky', 'life-size', 'slim', 'chunky', 'limitless', 'small', 'colossal', 'little', 'squat',
		'compact', 'mammoth',
		'mini', 'teensy', 'emaciated', 'miniature', 'teeny', 'endless', 'minuscule', 'teeny-tiny', 'enormous', 'minute',
		'teeny-weeny',
		'mountainous', 'jumbo', 'dense', 'weighty', 'slim', 'trim', 'hulking', 'hefty', 'giant', 'plump', 'tubby', 'obese',
		'portly',
		'short', 'big', 'immense', 'sizable', 'bony', 'infinitesimal', 'skeletal', 'boundless', 'lanky', 'skimpy', 'brawny',
		'large', 'skinny', 'broad',
		'stocky', 'corpulent', 'massive', 'stout', 'cosmic', 'meager', 'strapping', 'cubby', 'measly', 'sturdy', 'curvy',
		'microscopic', 'tall',
		'svelte', 'scrawny', 'skeletal', 'underweight', 'lanky', 'wide', 'enormous', 'huge', 'vast', 'great', 'gigantic',
		'monstrous',
		'titanic', 'full-size', 'paltry', 'towering', 'gargantuan', 'petite', 'trifling', 'gaunt', 'pint-size', 'trim', 'giant',
		'plump', 'tubby',
		'epic', 'narrow', 'thick', 'expansive', 'obese', 'thickest', 'extensive', 'outsized', 'thin', 'fat', 'oversize', 'tiny',
		'fleshy', 'overweight'
	];

	public $ageAdjectives = [
		'old', 'young', 'years', 'days', 'aged', 'young', 'old', 'ancient', 'antique', 'old-fashioned', 'youthful', 'bygone',
		'recent', 'modern', 'medieval',
		'historic', 'pre historic'
	];

	public $shapeAdjectives = [
		'asymmetrical', 'spherical', 'concave', 'concentric', 'congruent', 'curved', 'deformed', 'convex', 'flat', 'round',
		'rectangular', 'triangular',
		'pointed', 'oval', 'straight', 'vertical', 'horizontal', 'two dimensional', 'three dimensional', 'circular', 'square',
		'triangular', 'oval', 'sleek',
		'blobby', 'flat', 'rotund', 'globular', 'spherical', 'wavy', 'straight', 'cylindrical', 'oblong', 'elliptical',
		'zigzag', 'squiggly', 'crooked', 'winding',
		'serpentine', 'warped', 'distorted'
	];

	public $colorAdjectivesPrepend = [
		'light', 'dark', 'bright', 'shadowy', 'drab', 'radiant', 'shining', 'pale', 'dull', 'glowing', 'shimmering', 'luminous',
		'gleaming'
	];

	public $colorAdjectives = [
		'red', 'orange', 'yellow', 'green', 'blue', 'purple', 'pink', 'brown', 'gray', 'black', 'white', 'silver', 'gold',
	...
	public $grammar = [
		...
		// (Not needed, as our new past tense checker now fixes it globally.)
		...
		[
			['" he said.'], [
				'" he said at last.', '" he said finally.', '" he said without hesitation.', '" he said conclusively.',
				'" he said affirmingly.'
			]
		],
		[
			['" she said.'], [
				'" she said at last.', '" she said finally.', '" she said without hesitation.',
				'" she said conclusively.', '" she said affirmingly.'
			]
		],
		...
		[
			['" he replied.'], [
				'" he replied at last.', '" he replied finally.', '" he replied without hesitation.',
				'" he replied conclusively.', '" he replied affirmingly.'
			]
		],
		[
			['" she replied.'], [
				'" she replied at last.', '" she replied finally.', '" she replied without hesitation.',
				'" she replied conclusively.', '" she replied affirmingly.'
			]
		],
		[
			['" he replied.'], [
				'" was the rejoinder.', '" he replied.', '" he answered.', '" was the rejoinder.', '" he replied.',
				'" was the response.', '" he retorted.', '" he riposted.', '" he countered.'
			]
		],
		[
			['" she replied.'], [
				'" was the rejoinder.', '" she answered.', '" she replied.', '" she replied.', '" was the response.',
				'" she retorted.', '" she riposted.', '" she countered.'
			]
		],
		[
			['" I replied.'], [
				'" was my rejoinder.', '" I replied.', '" I answered.', '" I replied.', '" was my response.',
				'" I retorted.', '" I riposted.', '" I countered.'
			]
		],
		[['travelled'], ['journeyed']],
		...
		[
			['correct '], [
				'appropriate ', 'certain ', 'consistent ', 'genuine ', 'justifiable ', 'logical ', 'natural ',
				'reasonable ', 'reliable ', 'well-founded '
			]
		],
		...
		[
			['jealous'], [
				'invidious', 'jaundiced', 'apprehensive', 'envious', 'intolerant', 'possessive', 'protective', 'begrudging',
				'covetous', 'doubting'
			]
		],
		...
		[
			['delicious'], [
				'savory', 'delectable', 'appetizing', 'luscious', 'scrumptious', 'palatable', 'delightful', 'enjoyable',
				'toothsome', 'exquisite'
			]
		],
		[
		...
		[
			['feel happy'], [
				'feel pleased', 'feel contented', 'feel satisfied', 'feel elated', 'feel joyful', 'feel cheerful',
				'feel ecstatic', 'feel jubilant', 'feel blissful', 'feel overjoyed'
			]
		],
		[
			['am happy'], [
				'am pleased', 'am contented', 'am satisfied', 'am elated', 'am joyful', 'am cheerful', 'am ecstatic',
				'am jubilant', 'am blissful', 'am overjoyed'
			]
		],
		...
		[
			['my thing for'], [
				'my proclivity for', 'my predisposition for', 'my taste for', 'my disposition for', 'my weakness for',
				'my penchant for'
			]
		],
		[
	...
	public $thesaurus = [
		...
		[
			['beautiful'], [
				'pretty', 'lovely', 'handsome', 'attractive', 'gorgeous', 'dazzling', 'splendid', 'magnificent', 'comely',
				'fair', 'ravishing', 'graceful', 'elegant', 'fine', 'exquisite', 'aesthetic', 'pleasing', 'shapely', 'delicate',
		...
		[
			['would cry'], [
				'would shout', 'would yell', 'would yowl', 'would scream', 'would roar', 'would bellow', 'would weep',
				'would wail', 'would sob', 'bawl'
			]
		],
		[
			['would shout'], [
				'would yell', 'would yowl', 'would scream', 'would roar', 'would bellow', 'would weep', 'would wail',
				'would sob', 'bawl'
			]
		],
		[
		...
		[
			['gross'], [
				'improper', 'coarse', 'indecent', 'crude', 'vulgar', 'outrageous', 'extreme', 'grievous', 'shameful',
				'uncouth', 'obscene', 'low'
			]
		],
		[
			['moody'], [
				'temperamental', 'changeable', 'short-tempered', 'glum', 'morose', 'sullen', 'mopish', 'irritable', 'testy',
				'peevish', 'fretful', 'spiteful', 'sulky', 'touchy'
			]
		],
		[
			['interesting'], [
				'fascinating', 'intriguing', 'provocative', 'though-provoking', 'inspiring', 'involving', 'moving',
				'titillating', 'tantalizing', 'exciting', 'entertaining', 'piquant', 'lively', 'racy', 'spicy', 'gripping',
		...
		[
			['good'], [
				...
				'proper', 'superb', 'respectable', 'edifying'
			]
		],
		...
		[
			['a great '], [
				'a noteworthy ', 'a worthy ', 'a distinguished ', 'a remarkable ', 'a grand ', 'a considerable ',
				'a powerful ', 'a much ', 'a mighty '
			]
		],
		[
		...
		[['crazy '], ['strange ', 'odd ', 'peculiar ', 'unusual ', 'unfamiliar ', 'uncommon ', 'curious ']][['mad'], ['preposterous', 'irrational', 'distracted', 'aberrant', 'frenetic', 'imprudent', 'unreasonable']],
		...
		[
			['bad'], [
				'evil', 'immoral', 'wicked', 'corrupt', 'sinful', 'depraved', 'spoiled', 'tainted', 'harmful', 'injurious',
				'unfavorable', 'defective', 'inferior', 'imperfect', 'substandard', 'faulty', 'improper', 'inappropriate', 'unsuitable',
				'disagreeable', 'unpleasant', 'unfriendly', 'irascible', 'horrible', 'atrocious', 'outrageous', 'scandalous', 'noxious',
				'sinister', 'putrid', 'snide', 'deplorable', 'dismal', 'heinous', 'nefarious', 'obnoxious', 'detestable', 'despicable',
				'contemptible', 'rank', 'ghastly', 'execrable'
			]
		],
		[
			['evil'], [
				'immoral', 'wicked', 'corrupt', 'sinful', 'depraved', 'spoiled', 'tainted', 'harmful', 'injurious',
				'unfavorable', 'defective', 'inferior', 'imperfect', 'substandard', 'faulty', 'improper', 'inappropriate', 'unsuitable',
				'disagreeable', 'unpleasant', 'unfriendly', 'irascible', 'horrible', 'atrocious', 'outrageous', 'scandalous', 'noxious',
				'sinister', 'putrid', 'snide', 'deplorable', 'dismal', 'heinous', 'nefarious', 'obnoxious', 'detestable', 'despicable',
				'contemptible', 'rank', 'ghastly', 'execrable'
		...
		[
			['big'], [
				'enormous', 'immense', 'sizable', 'grand', 'great', 'tall', 'substantial', 'ample', 'broad', 'expansive',
				'spacious', 'stout', 'tremendous', 'mountainous'
			]
		],
		[
			['brave'], [
		...
		[
			['false'], [
				'fake', 'fraudulent', 'counterfeit', 'spurious', 'untrue', 'unfounded', 'erroneous', 'deceptive', 'groundless',
				'fallacious'
			]
		],
		[
		...
		[
			['fast'], [
				'quick', 'rapid', 'speedy', 'fleet', 'hasty', 'snappy', 'mercurial', 'swiftly', 'rapidly', 'quickly',
				'snappily', 'speedily', 'lickety-split', 'posthaste', 'hastily', 'expeditiously', 'likeaflash'
			]
		],
		[
			['fat'], [
				'stout', 'corpulent', 'fleshy', 'beefy', 'paunchy', 'plump', 'full', 'rotund', 'tubby', 'pudgy', 'chubby',
		...
		[
			['get'], [
				'acquire', 'obtain', 'secure', 'procure', 'gain', 'fetch', 'find', 'score', 'accumulate', 'win', 'earn', 'rep',
				'catch', 'net', 'bag', 'derive', 'collect', 'gather', 'glean', 'pickup', 'accept', 'comeby', 'regain', 'salvage'
			]
		],
		[['go'], ['recede', 'depart', 'fade', 'disappear', 'move', 'travel', 'proceed']],
		[
			['good'], [
				'excellent', 'fine', 'superior', 'wonderful', 'marvelous', 'qualified', 'suited', 'suitable', 'apt', 'proper',
		...
		[
			['happy'], [
				'pleased', 'contented', 'satisfied', 'delighted', 'elated', 'joyful', 'cheerful', 'ecstatic', 'jubilant',
		...
		[
			['help'], [
				'aid', 'assist', 'support', 'encourage', 'back', 'waiton', 'attend', 'serve', 'relieve', 'succor', 'benefit',
				'befriend', 'abet'
			]
		],
		...
		[
			['interesting'], [
				'fascinating', 'engaging', 'sharp', 'keen', 'bright', 'intelligent', 'animated', 'spirited',
				'attractive', 'inviting', 'intriguing', 'provocative', 'though-provoking', 'challenging', 'inspiring', 'involving',
				'moving', 'titillating', 'tantalizing', 'exciting', 'entertaining', 'piquant', 'lively', 'racy', 'spicy', 'engrossing',
				'absorbing', 'consuming', 'gripping', 'arresting', 'enthralling', 'spellbinding', 'curious', 'captivating',
				'enchanting', 'bewitching', 'appealing'
			]
		],
		...
		[
			['little'], [
				'tiny', 'small', 'diminutive', 'runt', 'miniature', 'puny', 'exiguous', 'dinky', 'cramped', 'limited',
				'slight', 'petite', 'minute'
			]
		],
		[
			['look'], [
				'gaze', 'see', 'glance', 'watch', 'survey', 'study', 'seek', 'searchfor', 'peek', 'peep', 'glimpse', 'stare',
		...
		[
			['make'], [
				'create', 'originate', 'invent', 'beget', 'form', 'construct', 'design', 'fabricate', 'manufacture', 'produce',
		...
		[
			['mark'], [
				'label', 'tag', 'price', 'ticket', 'impress', 'effect', 'trace', 'imprint', 'stamp', 'brand', 'sign', 'note',
		...
		[
			['move'], [
				'plod', 'go', 'creep', 'crawl', 'inch', 'poke', 'drag', 'toddle', 'shuffle', 'trot', 'dawdle', 'walk',
				...
				'scamper', 'scurry', 'skedaddle', 'scoot', 'scuttle', 'scramble', 'race', 'chase', 'hasten', 'hurry', 'hump', 'gallop',
				'lope', 'accelerate', 'stir', 'budge', 'travel', 'wander', 'roam', 'journey', 'trek', 'ride', 'spin', 'slip', 'glide',
				'slide', 'slither', 'coast', 'flow', 'sail', 'saunter', 'hobble', 'amble', 'stagger', 'paddle', 'slouch', 'prance',
		...
		[
			['neat'], [
				'clean', 'orderly', 'tidy', 'trim', 'dapper', 'natty', 'smart', 'elegant', 'well-organized', 'super',
		...
		[
			['place'], [
				'space', 'area', 'spot', 'plot', 'region', 'location', 'situation', 'position', 'residence', 'dwelling', 'set',
				'site', 'station', 'status', 'state'
			]
		],
		[
			['plan'], [
				'plot', 'scheme', 'design', 'draw', 'map', 'diagram', 'procedure', 'arrangement', 'intention', 'device',
		...
		[
			['right'], [
				'correct', 'accurate', 'factual', 'true', 'good', 'just', 'honest', 'upright', 'lawful', 'moral', 'proper',
		...
		[
			['scared'], [
				'afraid', 'frightened', 'alarmed', 'terrified', 'panicked', 'fearful', 'unnerved', 'insecure', 'timid', 'shy',
		...
		[
			['story'], [
				'tale', 'myth', 'legend', 'fable', 'yarn', 'account', 'narrative', 'chronicle', 'epic', 'sage', 'anecdote',
				'record', 'memoir'
			]
		],
		[
			['strange'], [
				'odd', 'peculiar', 'unusual', 'unfamiliar', 'uncommon', 'queer', 'weird', 'outlandish', 'curious', 'unique',
				'exclusive', 'irregular'
			]
		],
		[
		...
		[
			['trouble'], [
				'distress', 'anguish', 'anxiety', 'worry', 'wretchedness', 'pain', 'danger', 'peril', 'disaster', 'grief',
				'misfortune', 'difficulty', 'concern', 'pains', 'inconvenience', 'exertion', 'effort'
			]
		],
		[
			['true'], [
				'accurate', 'right', 'proper', 'precise', 'exact', 'valid', 'genuine', 'real', 'actual', 'trusty', 'steady',
				'loyal', 'dependable', 'sincere', 'staunch'
			]
		],
		[
			['ugly'], [
				'hideous', 'frightful', 'frightening', 'shocking', 'horrible', 'unpleasant', 'monstrous', 'terrifying', 'gross',
				'grisly', 'ghastly', 'horrid', 'unsightly', 'plain', 'homely', 'evil', 'repulsive', 'repugnant', 'gruesome'
			]
		],
		[
			['unhappy'], [
				'miserable', 'uncomfortable', 'wretched', 'heart-broken', 'unfortunate', 'poor', 'downhearted', 'sorrowful',
				'depressed', 'dejected', 'melancholy', 'glum', 'gloomy', 'dismal', 'discouraged', 'sad'
			]
		],
		[['wrong'], ['incorrect', 'inaccurate', 'mistaken', 'erroneous', 'improper', 'unsuitable']]
	];
